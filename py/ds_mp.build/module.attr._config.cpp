...
static PyCodeObject *codeobj_abd0858d764fc833f28ec0a39da99030;
static PyCodeObject *codeobj_e41a338ce9f99cf25a332fc097ee8d2b;
...
static PyObject *impl_attr$_config$$$function__1_set_run_validators(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_f2c21437d2807d7e5ffe9421bf5561f9;
    ...
    static struct Nuitka_FrameObject *cache_frame_f2c21437d2807d7e5ffe9421bf5561f9 = NULL;
    PyObject *tmp_return_value = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_f2c21437d2807d7e5ffe9421bf5561f9)) {
        Py_XDECREF(cache_frame_f2c21437d2807d7e5ffe9421bf5561f9);

#if _DEBUG_REFCOUNTS
        if (cache_frame_f2c21437d2807d7e5ffe9421bf5561f9 == NULL) {
...
#endif
        cache_frame_f2c21437d2807d7e5ffe9421bf5561f9 = MAKE_FUNCTION_FRAME(codeobj_f2c21437d2807d7e5ffe9421bf5561f9, module_attr$_config, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_f2c21437d2807d7e5ffe9421bf5561f9->m_type_description == NULL);
    frame_f2c21437d2807d7e5ffe9421bf5561f9 = cache_frame_f2c21437d2807d7e5ffe9421bf5561f9;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_f2c21437d2807d7e5ffe9421bf5561f9);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_f2c21437d2807d7e5ffe9421bf5561f9) == 2); // Frame stack
    ...
    branch_yes_1:;
    {
        ...
        frame_f2c21437d2807d7e5ffe9421bf5561f9->m_frame.f_lineno = 14;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_f2c21437d2807d7e5ffe9421bf5561f9);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_f2c21437d2807d7e5ffe9421bf5561f9, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_f2c21437d2807d7e5ffe9421bf5561f9->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_f2c21437d2807d7e5ffe9421bf5561f9, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_f2c21437d2807d7e5ffe9421bf5561f9,
        type_description_1,
        par_run
    );
    ...
    if (frame_f2c21437d2807d7e5ffe9421bf5561f9 == cache_frame_f2c21437d2807d7e5ffe9421bf5561f9) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_f2c21437d2807d7e5ffe9421bf5561f9);
        cache_frame_f2c21437d2807d7e5ffe9421bf5561f9 = NULL;
    }

    assertFrameObject(frame_f2c21437d2807d7e5ffe9421bf5561f9);
...
static PyObject *impl_attr$_config$$$function__2_get_run_validators(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    struct Nuitka_FrameObject *frame_e41a338ce9f99cf25a332fc097ee8d2b;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_e41a338ce9f99cf25a332fc097ee8d2b = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_e41a338ce9f99cf25a332fc097ee8d2b)) {
        Py_XDECREF(cache_frame_e41a338ce9f99cf25a332fc097ee8d2b);

#if _DEBUG_REFCOUNTS
        if (cache_frame_e41a338ce9f99cf25a332fc097ee8d2b == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_e41a338ce9f99cf25a332fc097ee8d2b = MAKE_FUNCTION_FRAME(codeobj_e41a338ce9f99cf25a332fc097ee8d2b, module_attr$_config, 0);
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_e41a338ce9f99cf25a332fc097ee8d2b->m_type_description == NULL);
    frame_e41a338ce9f99cf25a332fc097ee8d2b = cache_frame_e41a338ce9f99cf25a332fc097ee8d2b;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_e41a338ce9f99cf25a332fc097ee8d2b);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_e41a338ce9f99cf25a332fc097ee8d2b) == 2); // Frame stack
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_e41a338ce9f99cf25a332fc097ee8d2b);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_e41a338ce9f99cf25a332fc097ee8d2b, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_e41a338ce9f99cf25a332fc097ee8d2b->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_e41a338ce9f99cf25a332fc097ee8d2b, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_e41a338ce9f99cf25a332fc097ee8d2b,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_e41a338ce9f99cf25a332fc097ee8d2b == cache_frame_e41a338ce9f99cf25a332fc097ee8d2b) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_e41a338ce9f99cf25a332fc097ee8d2b);
        cache_frame_e41a338ce9f99cf25a332fc097ee8d2b = NULL;
    }

    assertFrameObject(frame_e41a338ce9f99cf25a332fc097ee8d2b);
...
static PyObject *MAKE_FUNCTION_attr$_config$$$function__1_set_run_validators() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_f2c21437d2807d7e5ffe9421bf5561f9,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_attr$_config$$$function__2_get_run_validators() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_e41a338ce9f99cf25a332fc097ee8d2b,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_abd0858d764fc833f28ec0a39da99030;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    // Frame without reuse.
    frame_abd0858d764fc833f28ec0a39da99030 = MAKE_MODULE_FRAME(codeobj_abd0858d764fc833f28ec0a39da99030, module_attr$_config);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_abd0858d764fc833f28ec0a39da99030);
    assert(Py_REFCNT(frame_abd0858d764fc833f28ec0a39da99030) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_abd0858d764fc833f28ec0a39da99030);
#endif
    popFrameStack();

    assertFrameObject(frame_abd0858d764fc833f28ec0a39da99030);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_abd0858d764fc833f28ec0a39da99030, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_abd0858d764fc833f28ec0a39da99030->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_abd0858d764fc833f28ec0a39da99030, exception_lineno);
    }
