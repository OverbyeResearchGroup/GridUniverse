...
static PyObject *impl_gevent$_hub_local$$$function__5_get_hub_noargs(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
        PyObject *tmp_assign_source_2;
        PyObject *tmp_called_value_1;
        tmp_called_value_1 = GET_STRING_DICT_VALUE(moduledict_gevent$_hub_local, (Nuitka_StringObject *)mod_consts[9]);
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
        ...
        tmp_name_value_2 = GET_STRING_DICT_VALUE(moduledict_gevent$_hub_local, (Nuitka_StringObject *)mod_consts[24]);

        if (unlikely(tmp_name_value_2 == NULL)) {
            tmp_name_value_2 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[24]);
        }

        assert(!(tmp_name_value_2 == NULL));
        frame_fdfce9102d8474cfe6d83ed2d82aba36->m_frame.f_lineno = 24;
        tmp_expression_value_1 = IMPORT_MODULE1(tmp_name_value_2);
        if (tmp_expression_value_1 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_globals_arg_value_3 = (PyObject *)moduledict_gevent$_hub_local;
    ...
    }
    {
        ...
        tmp_called_value_4 = GET_STRING_DICT_VALUE(moduledict_gevent$_hub_local, (Nuitka_StringObject *)mod_consts[47]);
