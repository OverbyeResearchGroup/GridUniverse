...
static PyObject *impl_aiohttp$web_routedef$$$function__3_register(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_list_element_1 = impl___main__$$$function__4_complex_call_helper_pos_star_dict(dir_call_args);
        }
    ...
    branch_no_1:;
    {
...

        {
            ...
            tmp_list_element_2 = impl___main__$$$function__4_complex_call_helper_pos_star_dict(dir_call_args);
        }
