...
/* The "module_zmq$backend$select" is a Python object pointer of module type.
 *
...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("zmq.backend.select"));
...
static PyCodeObject *codeobj_dc105cb2bdf7098b3392ba669256e5a1;
...
static PyObject *impl_zmq$backend$select$$$function__1_select_backend(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_f388dcdf09c952870f44d5b2e9f47fbf;
    ...
    static struct Nuitka_FrameObject *cache_frame_f388dcdf09c952870f44d5b2e9f47fbf = NULL;
    ...
    // Tried code:
    if (isFrameUnusable(cache_frame_f388dcdf09c952870f44d5b2e9f47fbf)) {
        Py_XDECREF(cache_frame_f388dcdf09c952870f44d5b2e9f47fbf);

#if _DEBUG_REFCOUNTS
        if (cache_frame_f388dcdf09c952870f44d5b2e9f47fbf == NULL) {
...
#endif
        cache_frame_f388dcdf09c952870f44d5b2e9f47fbf = MAKE_FUNCTION_FRAME(codeobj_f388dcdf09c952870f44d5b2e9f47fbf, module_zmq$backend$select, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_f388dcdf09c952870f44d5b2e9f47fbf->m_type_description == NULL);
    frame_f388dcdf09c952870f44d5b2e9f47fbf = cache_frame_f388dcdf09c952870f44d5b2e9f47fbf;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_f388dcdf09c952870f44d5b2e9f47fbf);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_f388dcdf09c952870f44d5b2e9f47fbf) == 2); // Frame stack
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_f388dcdf09c952870f44d5b2e9f47fbf, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_f388dcdf09c952870f44d5b2e9f47fbf, exception_keeper_lineno_1);
    }
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_f388dcdf09c952870f44d5b2e9f47fbf->m_frame) frame_f388dcdf09c952870f44d5b2e9f47fbf->m_frame.f_lineno = exception_tb->tb_lineno;
    type_description_1 = "ooooo";
    ...
    // Tried code:
    {
        ...
        frame_f388dcdf09c952870f44d5b2e9f47fbf->m_frame.f_lineno = 36;
    ...
    }
    {
        ...
        tmp_iter_arg_1 = GET_STRING_DICT_VALUE(moduledict_zmq$backend$select, (Nuitka_StringObject *)mod_consts[5]);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_f388dcdf09c952870f44d5b2e9f47fbf);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_f388dcdf09c952870f44d5b2e9f47fbf, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_f388dcdf09c952870f44d5b2e9f47fbf->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_f388dcdf09c952870f44d5b2e9f47fbf, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_f388dcdf09c952870f44d5b2e9f47fbf,
        type_description_1,
        par_name,
        var_mod,
        var_e,
    ...
    if (frame_f388dcdf09c952870f44d5b2e9f47fbf == cache_frame_f388dcdf09c952870f44d5b2e9f47fbf) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_f388dcdf09c952870f44d5b2e9f47fbf);
        cache_frame_f388dcdf09c952870f44d5b2e9f47fbf = NULL;
    }

    assertFrameObject(frame_f388dcdf09c952870f44d5b2e9f47fbf);
...
static PyObject *MAKE_FUNCTION_zmq$backend$select$$$function__1_select_backend(PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_f388dcdf09c952870f44d5b2e9f47fbf,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
function_impl_code functable_zmq$backend$select[] = {
    impl_zmq$backend$select$$$function__1_select_backend,
    NULL
};
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_zmq$backend$select;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_zmq$backend$select) || offset < 0) {
    ...
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        functable_zmq$backend$select[offset],
        code_object->co_name,
#if PYTHON_VERSION >= 0x300
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_zmq$backend$select);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_dc105cb2bdf7098b3392ba669256e5a1;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    // owning it.
    pushFrameStack(frame_dc105cb2bdf7098b3392ba669256e5a1);
    assert(Py_REFCNT(frame_dc105cb2bdf7098b3392ba669256e5a1) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_dc105cb2bdf7098b3392ba669256e5a1);
#endif
    popFrameStack();

    assertFrameObject(frame_dc105cb2bdf7098b3392ba669256e5a1);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_dc105cb2bdf7098b3392ba669256e5a1, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_dc105cb2bdf7098b3392ba669256e5a1->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_dc105cb2bdf7098b3392ba669256e5a1, exception_lineno);
    }
